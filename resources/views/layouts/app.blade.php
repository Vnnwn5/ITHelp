...
<head>
    ...
    <script src="https://kit.fontawesome.com/5338d891d5.js" crossorigin="anonymous"></script>
...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        @auth
                            ...
                            @can('check-admin')
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('tecnicos.index') }}">Tecnicos</a>
                                </li>
                            @endcan
                        @endauth
                    </ul>
    ...
    <!-- Scripts -->
    <script src="{{ asset('js/app.js') }}?zo"></script>
